                    ...
                    <div class="row flex-center pt-5 mt-3">
                        <div class="col-md-6 text-center text-md-left mb-5">
                            <div class="white-text">
                                ...
                                <br>
                                <p class="wow fadeInLeft" data-wow-delay="0.3s"> No account ? <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-white wow fadeInLeft waves-effect waves-light" data-wow-delay="0.3s" style="animation-name: none; visibility: visible;">Sign Up</a> </p>
                            </div>
                        </div>
