...
<div class="col-lg-9">
    ...
    <div class="row wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
        <div class="col-lg-12">
            ...
            <h3>Displaying all search results for <strong style="font-weight: 900; color: #0275d8!important;"><?php echo e($query); ?></strong> ...<span class="badge badge-primary badge-pill left" style="float: right;font-size: medium; font-weight: normal;"><?php echo e(count($cards)); ?> found</span>  </h3>
            <hr>
            <br> 
